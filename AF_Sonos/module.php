...

{
		...
		global   $action_ID, $parent_id, $master_IP_id,$player_data_id,$content_var_name_string_id,$Sonos_Data,$list,$var_change_script_id,$zone_var_change_script_id,
					...
					$script2,$script3,$content_var_php_class_name_string,$sonos_data_via_php_class_id,$content_var_php_script_name_string,$zone_var_change_script_name ;
   ...
   public function create_categories_zone_master()
   {
		...
		public function create_links()
		{
			global 	$parent_id,$action_ID, $player_data_id,$Mute_id,$Volume_id,$Sonos_Master_id ,$Sonos_Data,
					...
					if(@IPS_GetObjectIDByName (IPS_GetObject ($player_data_id)['ObjectName'], $visu_id )== false)
					{
					...
					if(@IPS_GetObjectIDByName (IPS_GetObject ($action_ID)['ObjectName'], $visu_id )== false)
					{
						$LinkID = IPS_CreateLink();             // Link anlegen
					...
					if(@IPS_GetObjectIDByName (IPS_GetObject ($Zone_cat_name)['ObjectName'], $visu_id )== false)
					{
						$LinkID = IPS_CreateLink();             // Link anlegen
